...
from linebot.models import (MessageEvent,TextMessage,TextSendMessage , TemplateSendMessage , ButtonsTemplate , 
                                           ...
                                           CarouselColumn , FlexSendMessage , ImageSendMessage , StickerSendMessage)
import re
    ...
    if re.match(r'^(?!.*2)第\d{1,2}題[A-F]{2,6}$', line):
        ...
        try:
            ...
            line_bot_api.reply_message(event.reply_token , TextSendMessage(
                    '您好，歡迎使用法國巴黎人壽客服LineBot機器人，為了您尋找最好的保險商品，請先協助我們完成風險性的問卷。請輸入"開始風險測驗" 或 "作答方式"輔助作答'
            ))
        ...
        try:
            message = [
                TextSendMessage(
                    text="{}\n測驗結束！\n謝謝您參與本次測驗！\n-------------------------------\n經過風險評估問卷調查，是屬於偏保守的投資者，建議您可以購買風險等級RR2-3的投資產品，若您有需求請通知我們，我們將第一時間提供您專業的諮詢！" .format(reply_message)
                ),
                StickerSendMessage(
                    package_id = '6632',
                    sticker_id = '11825385'
        ...
        try:
            message = [
                TextSendMessage(
                    text=('您好，歡迎使用法國巴黎人壽客服LineBot機器人，為了您尋找最好的保險商品，請先協助我們完成風險性的問卷。請輸入"開始風險測驗" 或 "作答方式"輔助作答')
                ),
                StickerSendMessage(
                    package_id = '6359',
                    sticker_id = '11069856'
